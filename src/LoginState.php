...
class LoginState extends CommonDBTM
{
    ...
    public const SAML_RESPONSE              = 'serverParams';   // Stores the Saml Response TODO:rename to something more accurate
    public const SAML_REQUEST               = 'requestParams';  // Stores the SSO request TODO:rename to something more accurate
    ...
    private function getState(string $samlInResponseTo = '') : void
    {
        ...
        if($sessionIterator->numrows() > 0){
            ...
            if(($this->state[LoginState::SAML_UNSOLICITED] === null) &&
                $samlInResponseTo                                    ){
                $this->state = array_merge($this->state, [LoginState::SAML_UNSOLICITED  => false]);
            }
        } else {
